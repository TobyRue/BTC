...
public class WeatheredFanBlock extends WaxedCopperFanBlock implements Oxidizable, ModBlockEntityProvider<FanBlockEntity>, ModTickBlockEntityProvider<FanBlockEntity> {
    ...
    public WeatheredFanBlock(Settings settings, OxidationLevel oxidationLevel) {
        super(settings);
    ...
    public BlockEntityType<FanBlockEntity> getBlockEntityType() {
        return ModBlockEntities.WEATHERED_COPPER_FAN_BLOCK_ENTITY;
    }
}
