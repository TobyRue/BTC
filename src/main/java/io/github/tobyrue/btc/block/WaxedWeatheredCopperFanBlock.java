...
public class WaxedWeatheredCopperFanBlock extends WaxedCopperFanBlock implements ModBlockEntityProvider<FanBlockEntity>, ModTickBlockEntityProvider<FanBlockEntity> {
    ...
    public WaxedWeatheredCopperFanBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntityType<FanBlockEntity> getBlockEntityType() {
        return ModBlockEntities.WAXED_WEATHERED_COPPER_FAN_BLOCK_ENTITY;
    }
}
