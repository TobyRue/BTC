...
public class ModBlockEntities {
    ...
    public static BlockEntityType<StructureCoreBlockEntity> STRUCTURE_CORE_BLOCK_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE, BTC.identifierOf("structure_core"), BlockEntityType.Builder.create(StructureCoreBlockEntity::new, ModBlocks.STRUCTURE_CORE).build());
