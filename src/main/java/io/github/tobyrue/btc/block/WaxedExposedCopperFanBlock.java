...
public class WaxedExposedCopperFanBlock extends WaxedCopperFanBlock implements ModBlockEntityProvider<FanBlockEntity>, ModTickBlockEntityProvider<FanBlockEntity> {
    ...
    public WaxedExposedCopperFanBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntityType<FanBlockEntity> getBlockEntityType() {
        return ModBlockEntities.WAXED_EXPOSED_COPPER_FAN_BLOCK_ENTITY;
    }
}
