...
public class OxidizedFanBlock extends WaxedCopperFanBlock implements Oxidizable, ModBlockEntityProvider<FanBlockEntity>, ModTickBlockEntityProvider<FanBlockEntity> {
    ...
    public OxidizedFanBlock(Settings settings, OxidationLevel oxidationLevel) {
        super(settings);
    ...
    public BlockEntityType<FanBlockEntity> getBlockEntityType() {
        return ModBlockEntities.OXIDIZED_COPPER_FAN_BLOCK_ENTITY;
    }
}
