...
public class ExposedFanBlock extends WaxedCopperFanBlock implements Oxidizable, ModBlockEntityProvider<FanBlockEntity>, ModTickBlockEntityProvider<FanBlockEntity> {
    ...
    public ExposedFanBlock(Settings settings, OxidationLevel oxidationLevel) {
        super(settings);
    ...
    public BlockEntityType<FanBlockEntity> getBlockEntityType() {
        return ModBlockEntities.EXPOSED_COPPER_FAN_BLOCK_ENTITY;
    }
}
