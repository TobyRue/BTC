...
public class ModInventoryItemRegistry {
    ...
    public static void initialize() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS).register(content -> {
            ...
            content.addAfter(Blocks.CHISELED_TUFF_BRICKS, ModBlocks.FANCY_CHISELED_TUFF_BRICKS, ModBlocks.FANCIER_CHISELED_TUFF_BRICKS, ModBlocks.CHISELED_TUFF_BRICKS_PILLAR, ModBlocks.CHISELED_TUFF_BRICKS_PILASTER);
