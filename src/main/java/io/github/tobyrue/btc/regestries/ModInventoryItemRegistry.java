...
//            }
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FUNCTIONAL).register(content -> {
            ...
            content.addAfter(Blocks.ENCHANTING_TABLE, ModBlocks.DUNGEON_WIRE, ModBlocks.PEDESTAL, ModBlocks.KEY_DISPENSER_BLOCK, ModBlocks.KEY_ACCEPTOR, ModBlocks.POTION_PILLAR, ModBlocks.DUNGEON_DOOR, ModBlocks.DUNGEON_FLAME, ModBlocks.DEEP_FLAME, ModBlocks.FORTRESS_FLAME, ModBlocks.BRAZIER);
