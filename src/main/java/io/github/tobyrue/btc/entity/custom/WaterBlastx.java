...
//public class WaterBlast extends EntityModel<Entity> {
...
//	public WaterBlast(ModelPart root) {
...
//
//		ModelPartData cube_r1 = head.addChild("cube_r1", ModelPartBuilder.create().uv(0, 0).cuboid(-2.0F, -3.0F, -2.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
//
//		ModelPartData tail = waterBlast.addChild("tail", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 8.0F, 0.0F));
//
//		ModelPartData bottom = tail.addChild("bottom", ModelPartBuilder.create().uv(0, 13).cuboid(-3.0F, -4.0F, -1.0F, 4.0F, 0.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(1.0F, -2.0F, 3.0F));
//
//		ModelPartData top = tail.addChild("top", ModelPartBuilder.create().uv(0, 8).cuboid(-3.0F, -4.0F, -1.0F, 4.0F, 0.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(1.0F, -6.0F, 3.0F));
//
//		ModelPartData right = tail.addChild("right", ModelPartBuilder.create().uv(18, 0).cuboid(1.0F, -4.0F, -1.0F, 0.0F, 4.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(-3.0F, -6.0F, 3.0F));
//
