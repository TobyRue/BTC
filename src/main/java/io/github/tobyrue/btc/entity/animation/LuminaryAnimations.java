...
public class LuminaryAnimations {
    public static final Animation LUMINARY_CAST = Animation.Builder.create(0.6766666f).looping()
            ...
            .addBoneAnimation("right_arm",
                    new Transformation(Transformation.Targets.ROTATE,
                            ...
                            new Keyframe(0.16766666f, AnimationHelper.createRotationalVector(7f, 0f, -35f),
                                    Transformation.Interpolations.CUBIC),
                            new Keyframe(0.3433333f, AnimationHelper.createRotationalVector(0f, 0f, -35f),
                                    Transformation.Interpolations.CUBIC),
                            new Keyframe(0.5f, AnimationHelper.createRotationalVector(-7f, 0f, -35f),
                                    Transformation.Interpolations.CUBIC),
                            new Keyframe(0.6766666f, AnimationHelper.createRotationalVector(0f, 0f, -35f),
                                    Transformation.Interpolations.CUBIC)))
            .addBoneAnimation("right_arm",
                    new Transformation(Transformation.Targets.SCALE,
                            new Keyframe(0f, AnimationHelper.createScalingVector(0.86f, 0.86f, 0.86f),
                                    Transformation.Interpolations.LINEAR)))
    ...
    public static final Animation LUMINARY_WALK = Animation.Builder.create(1.25f).looping()
            .addBoneAnimation("right_arm",
                    new Transformation(Transformation.Targets.TRANSLATE,
            ...
            .addBoneAnimation("bottom",
                    new Transformation(Transformation.Targets.SCALE,
                            new Keyframe(0f, AnimationHelper.createScalingVector(1f, 1f, 1f),
                                    Transformation.Interpolations.LINEAR))).build();
    public static final Animation LUMINARY_IDLE = Animation.Builder.create(4f).looping()
            ...
            .addBoneAnimation("whole_body",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            ...
                            new Keyframe(4f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR)))
            .addBoneAnimation("right_leg_cloak",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR),
                            new Keyframe(2f, AnimationHelper.createTranslationalVector(0f, -0.2f, 0f),
                            ...
                            new Keyframe(4f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR)))
            .addBoneAnimation("left_leg_cloak",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR),
                            new Keyframe(2f, AnimationHelper.createTranslationalVector(0f, -0.2f, 0f),
