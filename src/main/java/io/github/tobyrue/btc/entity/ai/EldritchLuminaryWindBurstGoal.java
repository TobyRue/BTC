...
public class EldritchLuminaryWindBurstGoal extends Goal {
    ...
    private boolean isPreparingAttack = false; // Sync with animation state
    private int attackAnimationTicks = 25; // Timing for attack in animation (1.5 seconds)
    ...
    private boolean isEnemyWithinAttackDistance(LivingEntity eEnemy) {
        return this.luminary.distanceTo(eEnemy) >= 4f; // TODO
    }
    @Override
...
//                }
                ...
                this.isPreparingAttack = false; // Reset preparation flag
