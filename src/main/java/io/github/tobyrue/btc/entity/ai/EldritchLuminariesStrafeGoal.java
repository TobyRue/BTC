...
public class EldritchLuminariesStrafeGoal<T extends HostileEntity & RangedAttackMob> extends Goal{
        ...
        public EldritchLuminariesStrafeGoal(T actor, double speed, int attackInterval, float range) {
            this.actor = actor;
            this.speed = speed;
