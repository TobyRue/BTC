...
public class HexagonValues {
    ...
    public record RadialIdentifiers(Identifier backgroundOutlineTexture, float backgroundOutlineTransparency, Identifier backgroundTexture, float backgroundTransparency, Identifier highlightedShapeTexture, float highlightedShapeTransparency, int radius) {}
}
