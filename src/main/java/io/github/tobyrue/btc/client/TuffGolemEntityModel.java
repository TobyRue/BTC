...
public class TuffGolemEntityModel <T extends TuffGolemEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData slider = body_2.addChild("slider", ModelPartBuilder.create().uv(34, 43).cuboid(-4.0F, -1.0F, -3.0F, 8.0F, 2.0F, 6.0F, new Dilation(-0.01F))
		.uv(34, 51).cuboid(-4.0F, -1.0F, -3.0F, 8.0F, 3.0F, 0.0F, new Dilation(-0.01F)), ModelTransform.of(0.0F, 3.0F, -1.0F, 1.5708F, 0.0F, 0.0F));
