...
public class WaterStaffModelRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    ...
    public static final Identifier TEXTURE = BTC.identifierOf("textures/item/water_staff_overlay.png");
    ...
    public void render(ItemStack stack, ModelTransformationMode mode, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        switch (mode) {
            case FIRST_PERSON_RIGHT_HAND, FIRST_PERSON_LEFT_HAND -> {
                ...
                currentItemX = 0.25f; currentItemY = 1.1f; currentItemZ = 0.5f;
                currentItemScale = 0.5f; currentScale = 1;
            }
            case THIRD_PERSON_RIGHT_HAND, THIRD_PERSON_LEFT_HAND -> {
                currentRotX = 32; currentRotY = 0; currentRotZ = 0;
                currentTransX = 0.5f; currentTransY = -0.2f; currentTransZ = 0.55f;
                currentItemX = 0.25f; currentItemY = 0.7f; currentItemZ = 0.8f;
                currentItemScale = 0.5f; currentScale = 1;
            }
            case GUI -> {
                currentRotX = 45; currentRotY = 45; currentRotZ = 0;
                currentTransX = 0.4f; currentTransY = 1; currentTransZ = 0.2f;
                currentItemX = 0.5f; currentItemY = 1.7f; currentItemZ = 0;
                currentItemScale = 0.65f; currentScale = 2;
            }
            case GROUND -> {
                currentRotX = 20; currentRotY = 0; currentRotZ = 0;
                currentTransX = 0.5f; currentTransY = 0.15f; currentTransZ = 0.55f;
                currentItemX = 0.25f; currentItemY = 1.2f; currentItemZ = 0.65f;
                currentItemScale = 0.5f; currentScale = 2;
            }
            case FIXED -> {
                currentRotX = 0; currentRotY = 0; currentRotZ = 0;
                currentTransX = 0.5f; currentTransY = 0.67f; currentTransZ = 0.5f;
                currentItemX = 0.25f; currentItemY = 1.2f; currentItemZ = 0.25f;
                currentItemScale = 0.5f; currentScale = 1.3f;
            }
            case HEAD -> {
                currentRotX = 0; currentRotY = 0; currentRotZ = 0;
                currentTransX = 0.5f; currentTransY = 0.9f; currentTransZ = 0.25f;
                currentItemX = 0.25f; currentItemY = 1.5f; currentItemZ = 0;
                currentItemScale = 0.5f; currentScale = 1.3f;
            }
            default -> {}
        }
