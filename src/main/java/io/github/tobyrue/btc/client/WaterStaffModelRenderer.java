...
public class WaterStaffModelRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    public static final ItemStack HANDLE_WATER = new ItemStack(ModItems.STAFF, 1);
    ...
    public void render(ItemStack stack, ModelTransformationMode mode, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        minecraft.getItemRenderer().renderItem(HANDLE_WATER, ModelTransformationMode.FIRST_PERSON_RIGHT_HAND, light, overlay, matrices, vertexConsumers, minecraft.world, 0);
        MinecraftClient.getInstance().getTextureManager().bindTexture(TEXTURE);
