...
public class EarthStaffModelRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    ...
    public static final Identifier TEXTURE = BTC.identifierOf("textures/item/earth_staff_overlay.png");
    ...
    public void renderItem(ItemStack stack, ModelTransformationMode mode, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay, float currentItemX, float currentItemY, float currentItemZ, float currentRotX, float currentRotZ, float currentItemScale) {
        ...
        float tumbleRotX = (time * 130.0f) % 360.0f;
        float tumbleRotY = (time * 210.0f) % 360.0f;
        float tumbleRotZ = (time * 85.0f) % 360.0f;

        applyTransformations(matrices, currentItemX, currentItemY, currentItemZ, currentRotX, 0, currentRotZ, currentItemScale);

        matrices.translate(0.0F, -0.2F, 0.0F);
        matrices.multiply(RotationAxis.POSITIVE_X.rotationDegrees(tumbleRotX));
        matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(tumbleRotY));
        matrices.multiply(RotationAxis.POSITIVE_Z.rotationDegrees(tumbleRotZ));
        matrices.translate(0.0F, -0.2F, 0.0F);
    ...
    public void render(ItemStack stack, ModelTransformationMode mode, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        switch (mode) {
            case FIRST_PERSON_RIGHT_HAND, FIRST_PERSON_LEFT_HAND -> {
                ...
                currentItemX = 0.5f; currentItemY = 1.4f; currentItemZ = 0.95f;
            ...
            case THIRD_PERSON_RIGHT_HAND, THIRD_PERSON_LEFT_HAND -> {
                ...
                currentItemX = 0.5f; currentItemY = 0.8f; currentItemZ = 1.15f;
                currentItemScale = 1; currentScale = 1;
            }
            case GUI -> {
                currentRotX = 45; currentRotY = 45; currentRotZ = 0;
                currentTransX = 0.4f; currentTransY = 1; currentTransZ = 0.2f;
                currentItemX = 0.1f; currentItemY = 1.9f; currentItemZ = 0;
            ...
            case GROUND -> {
                ...
                currentItemX = 0.5f; currentItemY = 1.45f; currentItemZ = 1;
            ...
            case FIXED -> {
                ...
                currentItemX = 0.5f; currentItemY = 1.7f; currentItemZ = 0.5f;
                currentItemScale = 1; currentScale = 1.3f;
            }
            case HEAD -> {
                currentRotX = 0; currentRotY = 0; currentRotZ = 0;
                currentTransX = 0.5f; currentTransY = 0.9f; currentTransZ = 0.25f;
                currentItemX = 0.5f; currentItemY = 1.9f; currentItemZ = 0.25f;
                currentItemScale = 1; currentScale = 1.3f;
            }
            default -> {}
        }
