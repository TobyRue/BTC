...
public class WindStaffEntityModel extends Model {
    public WindStaffEntityModel(Function<Identifier, RenderLayer> layerFactory) {
        super(layerFactory);
    }
