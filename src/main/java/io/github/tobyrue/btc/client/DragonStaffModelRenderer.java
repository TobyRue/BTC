...
public class DragonStaffModelRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    ...
    public static final Identifier TEXTURE = BTC.identifierOf("textures/item/dragon_staff_overlay.png");
    ...
    public void render(ItemStack stack, ModelTransformationMode mode, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        float currentRotX = rotX, currentRotY = rotY, currentRotZ = rotZ;
        float currentTransX = transX, currentTransY = transY, currentTransZ = transZ;
        float currentItemX = itemTransX, currentItemY = itemTransY, currentItemZ = itemTransZ;
        float currentItemScale = itemScale, currentScale = scale;

        switch (mode) {
            case FIRST_PERSON_RIGHT_HAND, FIRST_PERSON_LEFT_HAND -> {
                currentRotX = 27; currentRotY = 0; currentRotZ = 0;
                currentTransX = 0.5f; currentTransY = 0.5f; currentTransZ = 0.5f;
                currentItemX = 0.5f; currentItemY = 1; currentItemZ = 0.75f;
                currentItemScale = 0.23f; currentScale = 1;
            }
            case THIRD_PERSON_RIGHT_HAND, THIRD_PERSON_LEFT_HAND -> {
                currentRotX = 32; currentRotY = 0; currentRotZ = 0;
                currentTransX = 0.5f; currentTransY = -0.2f; currentTransZ = 0.55f;
                currentItemX = 0.5f; currentItemY = 0.4f; currentItemZ = 0.9f;
                currentItemScale = 0.35f; currentScale = 1;
            }
            case GUI -> {
                currentRotX = 45; currentRotY = 45; currentRotZ = 0;
                currentTransX = 0.4f; currentTransY = 1; currentTransZ = 0.2f;
                currentItemX = 0.6f; currentItemY = 1.5f; currentItemZ = 0;
                currentItemScale = 0.35f; currentScale = 2;
            }
            case GROUND -> {
                currentRotX = 20; currentRotY = 0; currentRotZ = 0;
                currentTransX = 0.5f; currentTransY = 0.15f; currentTransZ = 0.55f;
                currentItemX = 0.5f; currentItemY = 1.1f; currentItemZ = 0.9f;
                currentItemScale = 0.35f; currentScale = 2;
            }
            case FIXED -> {
                currentRotX = 0; currentRotY = 0; currentRotZ = 0;
                currentTransX = 0.5f; currentTransY = 0.67f; currentTransZ = 0.5f;
                currentItemX = 0.5f; currentItemY = 1.2f; currentItemZ = 0.5f;
                currentItemScale = 0.35f; currentScale = 1.3f;
            }
            case HEAD -> {
                currentRotX = 0; currentRotY = 0; currentRotZ = 0;
        ...
        float currentOverlayRotX = rotX;
        float currentOverlayRotY = rotY;
        float currentOverlayRotZ = rotZ;

        float currentOverlayTransX = transX;
        float currentOverlayTransY = transY;
        float currentOverlayTransZ = transZ;
