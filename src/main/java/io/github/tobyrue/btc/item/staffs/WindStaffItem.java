...
public class WindStaffItem extends PredefinedSpellsItem {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (user instanceof ServerPlayerEntity serverPlayer) {
            ...
            if (getKnownSpells(playerData).isEmpty()) {
                addKnownSpell(serverPlayer, spellState, new Spell.InstancedSpell(ModSpells.WIND_CHARGE, GrabBag.empty()), null);
                ...
                addKnownSpell(serverPlayer, spellState, new Spell.InstancedSpell(ModSpells.STORM_PUSH, GrabBag.empty()), null);
                addKnownSpell(serverPlayer, spellState, new Spell.InstancedSpell(ModSpells.TEMPESTS_CALL, GrabBag.empty()), null);
                addKnownSpell(serverPlayer, spellState, new Spell.InstancedSpell(ModSpells.LOCALIZED_STORM_PUSH, GrabBag.empty()), null);
            }
        }
