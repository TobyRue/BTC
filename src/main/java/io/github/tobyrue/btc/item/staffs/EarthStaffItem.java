...
public class EarthStaffItem extends PredefinedSpellsItem {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (user instanceof ServerPlayerEntity serverPlayer) {
            ...
            if (getKnownSpells(playerData).isEmpty()) {
                ...
                addKnownSpell(serverPlayer, spellState, new Spell.InstancedSpell(ModSpells.CREEPER_WALL_BLOCK, GrabBag.empty()), null);
                addKnownSpell(serverPlayer, spellState, new Spell.InstancedSpell(ModSpells.CREEPER_WALL_CIRCLE, GrabBag.empty()), null);
                addKnownSpell(serverPlayer, spellState, new Spell.InstancedSpell(ModSpells.CREEPER_WALL_EXPLOSIVE_TRAP, GrabBag.empty()), null);
                addKnownSpell(serverPlayer, spellState, new Spell.InstancedSpell(ModSpells.POTION_AREA_EFFECT, GrabBag.fromMap(new HashMap<>() {{
